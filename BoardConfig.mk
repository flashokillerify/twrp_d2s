...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 71102464 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/samsung/f62
TARGET_KERNEL_CONFIG := f62_defconfig
